...
export const homepageSeoBlocks: HomepageSeoBlock[] = [
  {
    id: "what-is",
    title: { en: "What is TPOWER Online Casino Malaysia?", zh: "TPOWER线上博彩是什么？" },
    paragraphs: [
      { en: "TPOWER is an online gaming platform serving Malaysia. It integrates official gaming partners for slots, live casino, sports, fishing, lottery and promotions — and this website is the official customer support and download hub for TPOWER Malaysia users.", zh: "TPOWER线上博彩是面向马来西亚的官方平台。通过对接官方游戏合作伙伴，提供老虎机、真人视讯、体育博彩、捕鱼、彩票与优惠；本站同时是官方客服与下载入口。" },
      ...
      { en: "TPOWER is presented here with an emphasis on clarity, local payment familiarity, bilingual support, and responsible adult entertainment. Studio relationships are partnerships and platform integrations — not ownership claims. Provider context lives on [[/providers|Providers]] and [[/about|About TPOWER]].", zh: "这里介绍 TPOWER 时，重点放在说明清楚、本地支付好懂、中英客服和理性娱乐。与工作室的关系是合作与平台对接——不是拥有厂商品牌。厂商背景见 [[/providers|游戏供应商]] 与 [[/about|关于TPOWER]]。" },
