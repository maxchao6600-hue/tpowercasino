...
export const supportMethodCards: Array<{
...
}> = [
  {
    ...
    availability: { en: "Daily 10:00–02:00 MYT", zh: "每日 10:00–02:00（马时）" },
    response: { en: "Typically within 15 minutes during desk hours", zh: "台席时段内一般 15 分钟内" },
    description: {
      en: "Use WhatsApp for urgent account or payment help — login blocks, deposit status, withdrawal checks.",
      zh: "账户或支付紧急协助走 WhatsApp——登录阻断、存款状态、提现查询。",
    },
  ...
  },
  {
    ...
    response: { en: "Typically within 15 minutes during desk hours", zh: "台席时段内一般 15 分钟内" },
    description: {
      en: "Same official support desk on Telegram — use it when WhatsApp is unavailable or you prefer this chat app.",
      zh: "与 WhatsApp 同一官方台席的 Telegram 备用通道——另一款聊天工具不便时改走这里。",
    },
  ...
  },
  {
    ...
    response: { en: "Updates & announcements", zh: "动态与公告" },
    description: {
      en: "Follow official news and announcements — not for password resets or cashier disputes.",
      zh: "关注官方新闻与公告——不适合改密或收银台争议。",
    },
  ...
  },
  {
    ...
    response: { en: "Updates & announcements", zh: "动态与公告" },
    description: {
      en: "Promotions and highlights from the official page — account security cases belong on WhatsApp, Telegram or email.",
      zh: "官方优惠与精彩动态——账户安全个案请改走 WhatsApp、Telegram 或邮件。",
    },
  ...
  },
  {
    ...
    response: { en: "Updates & announcements", zh: "动态与公告" },
    description: {
      en: "Latest official posts and announcements — not a channel for password or payment resets.",
      zh: "官方最新帖文与公告——不用于改密或支付重置。",
    },
  ...
  },
  {
    ...
    description: {
      en: "Send detailed cases with attachments — timelines, screenshots, and references that need a written trail.",
      zh: "发送可附资料的详细个案——需要书面留痕的时间线、截图与参考号。",
    },
  ...
  },
  {
    ...
    description: {
      en: "Self-serve first for how-tos — check FAQ before opening a live chat ticket.",
      zh: "操作问题先自助——开即时聊天前先查 FAQ。",
    },
