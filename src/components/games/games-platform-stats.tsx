...
type GamesPlatformStatsProps = {
  locale: Locale;
  dictionary: Dictionary;
};

export function GamesPlatformStats({ dictionary }: GamesPlatformStatsProps) {
  ...
  const stats = [
    ...
    {
      key: "updates",
      value: t.platformStats.updatesValue,
      label: t.platformStats.updatesLabel,
      description: t.platformStats.updatesDescription,
    },
  ] as const;
  ...
  return (
    <section
      ref={sectionRef}
      className="relative mt-14 w-full overflow-hidden rounded-[28px] border border-border/70 bg-[#0a0a0a]"
      aria-labelledby="games-platform-stats-heading"
    >
      <div
