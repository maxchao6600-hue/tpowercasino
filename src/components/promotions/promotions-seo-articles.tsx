...
import type { PromotionsSeoBlock } from "@/data/promotions-seo";
import { SeoRichText } from "@/components/home/seo-rich-text";

type PromotionsSeoArticlesProps = {
  locale: Locale;
  blocks: PromotionsSeoBlock[];
};

/** Renders a slice of the promotions SEO pillar articles. */
export function PromotionsSeoArticles({
  locale,
  blocks,
}: PromotionsSeoArticlesProps) {
  return (
