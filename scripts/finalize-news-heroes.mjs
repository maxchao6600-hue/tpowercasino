/**
 * Optimize news hero artworks → 1600×900 WebP + official TPOWER logo.
 */
...
const frames = [
  ["news-hero-platform.png", "tpower-news-platform-desk.webp"],
  ["news-hero-vip.png", "tpower-news-vip-lounge.webp"],
  ["news-hero-sports.png", "tpower-news-sports-night.webp"],
  ["news-hero-security.png", "tpower-news-security-shield.webp"],
  ["news-hero-slots.png", "tpower-news-slots-glow.webp"],
  ["news-hero-apk.png", "tpower-news-apk-secure.webp"],
];
